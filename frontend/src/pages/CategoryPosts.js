    ...
    componentDidMount() {
        ...
        fetch(url, {
            ...
            .then(result => {
                ...
                console.log("result.category.posts: " + result.category.posts)
                console.log("result.category.posts stringify: " + JSON.stringify(result.category.posts))
                console.log("result.category stringify: " + JSON.stringify(result.category))
